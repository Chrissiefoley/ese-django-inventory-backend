        ...
        message = Mail(
            ...
            <html>
                <body style="font-family: Arial, sans-serif; padding: 20px;">
                    <div style="max-width: 600px; margin: 0 auto; background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 5px; padding: 20px;">
                        ...
                        <div style="background-color: white; padding: 15px; border-radius: 5px; margin: 15px 0;">
                            ...
                            <p style="margin: 5px 0;"><strong>Current Stock:</strong> <span style="color: #dc3545; font-weight: bold;">{current_stock} units</span></p>
                            <p style="margin: 5px 0;"><strong>Threshold:</strong> {settings.LOW_STOCK_THRESHOLD} units</p>
                        </div>
